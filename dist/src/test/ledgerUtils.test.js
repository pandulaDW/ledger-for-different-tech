...
const ledgerUtils_1 = require("../app/utils/ledgerUtils");
describe("ledger utility unit tests", () => {
    ...
    test("returns a correctly generated FORTNIGHTLY SeqItem list for two given dates", () => {
        expect(ledgerUtils_1.createDateSeq(new Date("2020-03-28"), new Date("2020-05-03"), 14)).toEqual(dateSeqListFortnightly());
    });
    test("returns a correctly generated FORTNIGHTLY SeqItem list when end day is a payment day", () => {
        ...
        expect(ledgerUtils_1.createDateSeq(new Date("2020-03-28"), new Date("2020-05-08"), 14)).toEqual(seqList);
    });
    test("returns a correctly generated FORTNIGHTLY SeqItem list when end day is before the first payment day", () => {
        expect(ledgerUtils_1.createDateSeq(new Date("2020-03-28"), new Date("2020-04-05"), 14)).toEqual([
            {
                startDate: "2020-03-28T00:00:00.000Z",
    ...
    test("returns a correctly generated WEEKLY SeqItem list for two given dates", () => {
        expect(ledgerUtils_1.createDateSeq(new Date("2020-03-28"), new Date("2020-04-15"), 7)).toEqual(dateSeqListWeekly());
    });
    test("returns a correctly generated WEEKLY SeqItem list when end day is a payment day", () => {
        ...
        expect(ledgerUtils_1.createDateSeq(new Date("2020-03-28"), new Date("2020-04-17"), 7)).toEqual(seqList);
    });
    test("returns a correctly generated WEEKLY SeqItem list when end day is before the first payment day", () => {
        expect(ledgerUtils_1.createDateSeq(new Date("2020-03-28"), new Date("2020-04-01"), 7)).toEqual([
            {
                startDate: "2020-03-28T00:00:00.000Z",
    ...
    test("returns a correctly generated MONTHLY SeqItem list for two given dates", () => {
        expect(ledgerUtils_1.createMonthSeq(new Date("2020-08-31"), new Date("2020-11-25"))).toEqual(dateSeqListMonthly());
    });
    test("returns a correctly generated MONTHLY SeqItem list when end day is a payment day", () => {
        ...
        expect(ledgerUtils_1.createMonthSeq(new Date("2020-08-31"), new Date("2020-11-30"))).toEqual(seqList);
    });
    test("returns a correctly generated MONTHLY SeqItem list when end day is before the first payment day", () => {
        expect(ledgerUtils_1.createMonthSeq(new Date("2020-08-31"), new Date("2020-09-15"))).toEqual([
            {
                startDate: "2020-08-31T00:00:00.000Z",
...
//# sourceMappingURL=ledgerUtils.test.js.map